     ...
     const adminRightSide = () => {
         return (
             <div className="card mb-4">
                ...
                <ul className="list-group">
                   <li className="list-group-item">
                      <span className="badge bg-success mx-3">Name:</span>{name}
                   </li>
                   <li className="list-group-item">
                      <span className="badge bg-success mx-3">Email:</span>{email}
                   </li>
                   <li className="list-group-item">
                      <span className="badge bg-danger mx-3">Admin Area</span>
                   </li>
                </ul>
             </div>
         )
